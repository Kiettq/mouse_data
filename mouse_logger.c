...
static int __init my_mouse_init(void) {
    printk(KERN_INFO "🔌 Loading Mouse Logger v3.0 (Circular Buffer)...\n");
...
static void __exit my_mouse_exit(void) {
    ...
    printk(KERN_INFO "👋 Unloaded Mouse Logger v3.0\n");
}
...
MODULE_DESCRIPTION("Mouse Logger Kernel Module v3.0 with Circular Buffer and JSON output");
